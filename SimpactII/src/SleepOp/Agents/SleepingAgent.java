...
/**
 *
 * @author Lucio -- this is a sleeping agent version of the basic agent (an age
 * ambivalent agent).
 */
public class SleepingAgent extends Agent implements SleepingAgentInterface{
    private boolean sleeping = false;
    public int warmUp;
    
    public SleepingAgent(SimpactII state, HashMap<String,Object> attributes){  
