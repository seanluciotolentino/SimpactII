...
import SimpactII.Agents.ConeAgeAgent;
 ...
 * @author Lucio
 */
public class ConeSleepingAgent extends ConeAgeAgent implements SleepingAgentInterface{
    
    private boolean sleeping = false;
    public int warmUp;
    
    public ConeSleepingAgent(SimpactII state, HashMap<String,Object> attributes){  
