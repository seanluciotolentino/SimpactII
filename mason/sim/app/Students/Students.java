...
public class Students extends SimState{
    ...
    public Network buddies = new Network(false); //flase means undirected
    ...
    public void start(){
        ...
        for(int i = 0; i < numStudents; i++) {
         ...
         //define like/dislike relationships in the netwokrs
        Bag students = buddies.getAllNodes(); //Bag is a MASON data structure
